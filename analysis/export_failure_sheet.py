...
OUT_CSV = (
    ...
    / "analysis"
    / "reports"
    / "heldout_failures_refined_hebrew_only_reader_friendly.csv"
)
OUT_MD = (
    ROOT
    / "analysis"
    / "reports"
    / "heldout_failures_refined_hebrew_only_reader_friendly.md"
)
...
def reader_note(row):
    ...
    return (
        f"The model misses '{gold}' for a reason not captured by the simple heuristics."
    )
