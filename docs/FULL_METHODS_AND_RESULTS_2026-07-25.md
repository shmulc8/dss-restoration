...
`data/derived/preserved_nonbib_chunks.jsonl`
...
- `analysis/reports/QD_RESEARCHER_BENCHMARK.md`
- `analysis/reports/qd_researcher_comparison.json`
- `analysis/reports/PRESERVED_RAG_LACUNA_LENGTHS.md`
- `analysis/reports/preserved_rag_lacuna_lengths.json`
...
- `analysis/reports/CROSS_CORPUS_CONNECTIONS.md`
- `analysis/reports/cross_corpus_connections.json`
...
- `analysis/reports/CROSS_CORPUS_EMBEDDING_BENCHMARK.md`
- `analysis/reports/cross_corpus_embedding_benchmark.json`
- `analysis/reports/CROSS_CORPUS_RETRIEVAL_ABLATION.md`
- `analysis/reports/cross_corpus_retrieval_ablation.json`
- `analysis/reports/CROSS_CORPUS_RETRIEVAL_INJECTION.md`
- `analysis/reports/cross_corpus_retrieval_injection.json`
- `analysis/reports/byt5_dev_benchmark.json`
