...
| **Char-MLM** | TavBERT Fine-Tuned | **20.58%** | **7.96%** [17.03%, 24.49%] | 20.58% | 0.209 | 0.118 | **0 / 729** (0.0%) |
...
| **Seq2Seq** | ByT5 Unified FT ($O\text{-len}$) | **5.35%** | **0.41%** [3.77%, 6.92%] | 5.35% | 0.137 | 0.016 | **0 / 729** (0.0%) |
...
| **MsBERT FT** | Exact Physical Length ($P0, \pm 0$, $n=59$) | **52.54%** | **69.49%** | — |
| **Human Scholar Control** | "Initial Reading" Baseline | 20.27% | 43.24% | — |
...
├── tests/                                <-- 68 unit tests passing via `uv run pytest` (5.5s)
