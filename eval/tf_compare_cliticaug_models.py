...
if __name__ == "__main__":
    ...
    print("==================================================")
    print("Model Name                             Top-1    Top-5   Top-10   Top-20")
    print(
        f"1. Base Span-Refined (ft_msbert)      {res_base['top1']:.1f}%   {res_base['top5']:.1f}%   {res_base['top10']:.1f}%   {res_base['top20']:.1f}%"
    )
    print(
        f"2. Clitic-Augmented (ft_msbert_aug)   {res_aug['top1']:.1f}%   {res_aug['top5']:.1f}%   {res_aug['top10']:.1f}%   {res_aug['top20']:.1f}%"
    )
