...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--cache-dir",
        type=Path,
        default=ROOT / "comparison" / "cache" / "cross_corpus_embeddings",
    )
    parser.add_argument(
        "--output-json",
        type=Path,
        default=ROOT / "comparison" / "reports" / "cross_corpus_embedding_benchmark.json",
    )
    parser.add_argument(
        "--output-markdown",
        type=Path,
        default=ROOT / "comparison" / "reports" / "CROSS_CORPUS_EMBEDDING_BENCHMARK.md",
    )
