...
from experiments.cross_corpus_connections import (  # noqa: E402
    DEFAULT_TF_ROOT,
    EPIGRAPHIC_BOOKS,
    QUMRAN_EXTRA_BOOKS,
    RABBINIC_BOOKS,
...
from curation.preserved_corpus import GAP_TOKEN, load_chunks, split_scrolls  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-json",
        type=Path,
        default=ROOT / "comparison" / "reports" / "cross_corpus_retrieval_ablation.json",
    )
    parser.add_argument(
        "--output-markdown",
        type=Path,
        default=ROOT / "comparison" / "reports" / "CROSS_CORPUS_RETRIEVAL_ABLATION.md",
    )
