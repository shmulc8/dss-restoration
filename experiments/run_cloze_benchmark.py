...
defined by the frozen scroll splits (data_preparation/dss_scroll_splits_v1.json).
...
from tuning.metrics_runner import compute_metrics, mcnemar_test, score_run_dir
